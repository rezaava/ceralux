                    ...
                    <table id="example" class="table table-striped table-bordered text-center" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="numeric-column">
                                    <div class="description-cell2">{{$customer->name}}</div>
                                </td>
                                <td class="numeric-column">
                                    <div class="description-cell2">{{$customer->phone}}</div>
                                </td>
                                <td class="numeric-column">
                                    <div class="description-cell2">{{$customer->address}}</div>
                                </td>
                                <td class="actions-column" style="white-space: nowrap">
                                    <div class="d-flex flex-wrap justify-content-center">
                                        <a href="/admin/user/add/{{ $customer->id }}" class="btn btn-sm btn-outline-primary m-1">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="/admin/user/delete/{{ $customer->id }}" class="btn btn-sm btn-outline-danger m-1">
