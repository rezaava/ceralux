...
<style>
    ...
    .article-btn {background-color: transparent !important; color: #d0bc7e !important; border: 2px solid #d0bc7e !important; width: 100%; transition: all 0.3s ease;}
    .article-btn:hover {background-color: #d0bc7e !important; color: #262f40 !important;}
    .article {border: solid 10px #ffffff; background-color: #fff8e4; padding: 10px; border-radius: 5px; height: 100%; display: flex; flex-direction: column;}
    .article-content {flex-grow: 1;}
    .article-title {color: #262f40; font-size: 1.5rem; margin-bottom: 10px; min-height: 72px;}
    .article-date {color: #6c757d; margin-bottom: 10px;}
    .article-excerpt {color: #262f40; margin-bottom: 15px; flex-grow: 1;}
</style>
@endsection
