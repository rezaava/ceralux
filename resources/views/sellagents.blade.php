...
<style>
    ...
    .sellagent {
        background: linear-gradient(145deg, rgba(208, 188, 126, 0.1), rgba(230, 211, 163, 0.1));
        padding: 15px;
        border-radius: 10px;
        margin-bottom: 20px;
    ...
    [dir="rtl"] .sellagent-content {
        text-align: right;
    }

    [dir="ltr"] .sellagent-content {
        text-align: left;
    }
...
<section class="py-5 container text-center" dir="{{ in_array(app()->getLocale(), ['fa','ar']) ? 'rtl' : 'ltr' }}">
    ...
    <div class="search-container" data-aos="fade-up" data-aos-delay="200">
        <input type="text" id="myInput" class="form-control" onkeyup="searchAgents()"
            placeholder="{{ __('messages.search_agents') }}" title="{{ __('messages.search_agents') }}">
    </div>
        ...
        <div class="row sellagent agent-item" data-aos="zoom-in-down" style="--aos-index: {{ $index + 1 }};">
            ...
            <div class="col-md-6">
                <img src="https://abadistile.com/wp-content/uploads/2024/06/eleman-frisco-lobby-120240-ll-1536x1536.jpg"
                    class="sellagent-img" alt="{{ $agent['title'] }}">
            </div>
        </div>
        @endforeach
    </div>
