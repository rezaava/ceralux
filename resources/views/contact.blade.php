...
<style>
    ...
    .slider-global-caption-l p {
        font-size: 1rem;
        color: #262f40;
    }

    .slider-global-caption i,
    .slider-global-caption-l i {
        font-size: 2.5rem;
        margin-bottom: 10px;
    }
...
<section class="py-5 container text-center" dir="{{ in_array(app()->getLocale(), ['fa','ar'])?'rtl':'ltr' }}">
    ...
    <div class="search-container" data-aos="fade-up" data-aos-delay="200">
        <input type="text" id="myInput" class="form-control" onkeyup="searchAgents()"
            placeholder="{{ __('messages.search_agents') }}">
    </div>
            ...
            <div class="sellagent" data-aos="fade-up" style="--aos-index: {{ $loop->index + 5 }};">
                <div class="row align-items-center">
                    <div class="col-md-6 text-end">
                        ...
                        <a href="tel:{{ $agent['phone'] }}" class="btn contact-btn">{{ __('messages.contact_agent')
                            }}</a>
                    </div>
                    <div class="col-md-6">
                        <img src="{{ $agent['image'] ?? 'https://abadistile.com/wp-content/uploads/2024/06/eleman-frisco-lobby-120240-ll-1536x1536.jpg' }}"
                            class="sellagent-img">
                    </div>
                </div>
            </div>
