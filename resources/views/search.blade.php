...
<section class="py-5 container text-center" dir="{{ in_array(app()->getLocale(), ['fa','ar']) ? 'rtl' : 'ltr' }}">
    ...
    <div class="search-container" data-aos="fade-up" data-aos-delay="200">
        <input type="text" id="myInput" class="form-control" onkeyup="searchProducts()"
            placeholder="{{__('messages.search_products')}}" title="{{__(" messages.search_products")}}">
    </div>
    <div class="row" id="productsContainer">
        @php
        $products = [
        ['title' => 'سرامیک آبی', 'image' =>
        'https://abadistile.com/wp-content/uploads/2024/06/eleman-frisco-lobby-120240-ll-1536x1536.jpg', 'link' =>
        '/products/info/1'],
        ['title' => 'سرامیک کلاسیک', 'image' =>
        'https://abadistile.com/wp-content/uploads/2024/06/eleman-frisco-lobby-120240-ll-1536x1536.jpg', 'link' =>
        '/products/info/2'],
        ['title' => 'سرامیک مدرن', 'image' =>
        'https://abadistile.com/wp-content/uploads/2024/06/eleman-frisco-lobby-120240-ll-1536x1536.jpg', 'link' =>
        '/products/info/3'],
        ['title' => 'سرامیک برنزی', 'image' =>
        'https://abadistile.com/wp-content/uploads/2024/06/eleman-frisco-lobby-120240-ll-1536x1536.jpg', 'link' =>
        '/products/info/4'],
        ['title' => 'سرامیک لوکس', 'image' =>
        'https://abadistile.com/wp-content/uploads/2024/06/eleman-frisco-lobby-120240-ll-1536x1536.jpg', 'link' =>
        '/products/info/5'],
        ['title' => 'سرامیک مینیمال', 'image' =>
        'https://abadistile.com/wp-content/uploads/2024/06/eleman-frisco-lobby-120240-ll-1536x1536.jpg', 'link' =>
        '/products/info/6'],
        ];
        @endphp
